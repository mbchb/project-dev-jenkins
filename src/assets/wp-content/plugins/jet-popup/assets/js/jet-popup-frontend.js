	...
	var JetPopup = {
		...
		init: function() {
			...
			$.each( widgets, function( widget, callback ) {
				elementorFrontend.hooks.addAction( '../../../../../frontend/element_ready/default.htm' + widget, callback );
			});
		...
		self.elementorFrontendInit = function() {
			...
			$content.find( 'div[data-element_type]' ).each( function() {
				...
				try {
					...
					window.elementorFrontend.hooks.doAction( '../../../../../frontend/element_ready/default.htm' + elementType, $this, $ );
